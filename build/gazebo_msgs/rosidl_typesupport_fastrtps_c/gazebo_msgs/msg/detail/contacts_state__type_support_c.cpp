...
bool cdr_serialize_gazebo_msgs__msg__ContactState(
  const gazebo_msgs__msg__ContactState * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_gazebo_msgs__msg__ContactState(
  eprosima::fastcdr::Cdr & cdr,
  gazebo_msgs__msg__ContactState * ros_message);
...
bool cdr_serialize_key_gazebo_msgs__msg__ContactState(
  const gazebo_msgs__msg__ContactState * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_gazebo_msgs__msg__ContactState(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_gazebo_msgs__msg__ContactState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_gazebo_msgs__msg__ContactsState(
  const gazebo_msgs__msg__ContactsState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: states
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_gazebo_msgs__msg__ContactState(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_deserialize_gazebo_msgs__msg__ContactsState(
  eprosima::fastcdr::Cdr & cdr,
  gazebo_msgs__msg__ContactsState * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: states
  {
    ...
    auto array_ptr = ros_message->states.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_gazebo_msgs__msg__ContactState(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gazebo_msgs__msg__ContactsState;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_serialize_key_gazebo_msgs__msg__ContactsState(
  const gazebo_msgs__msg__ContactsState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: states
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_gazebo_msgs__msg__ContactState(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t get_serialized_size_key_gazebo_msgs__msg__ContactsState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ContactsState__ros_msg_type * ros_message = static_cast<const _ContactsState__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: states
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_gazebo_msgs__msg__ContactState(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t max_serialized_size_key_gazebo_msgs__msg__ContactsState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_gazebo_msgs__msg__ContactState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const gazebo_msgs__msg__ContactsState * ros_message = static_cast<const gazebo_msgs__msg__ContactsState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_gazebo_msgs__msg__ContactsState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  gazebo_msgs__msg__ContactsState * ros_message = static_cast<gazebo_msgs__msg__ContactsState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_gazebo_msgs__msg__ContactsState(cdr, ros_message);
}
...
static size_t _ContactsState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gazebo_msgs__msg__ContactsState(
