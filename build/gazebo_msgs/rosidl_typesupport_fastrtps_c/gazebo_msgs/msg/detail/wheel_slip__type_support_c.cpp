...
bool cdr_serialize_gazebo_msgs__msg__WheelSlip(
  const gazebo_msgs__msg__WheelSlip * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_deserialize_gazebo_msgs__msg__WheelSlip(
  eprosima::fastcdr::Cdr & cdr,
  gazebo_msgs__msg__WheelSlip * ros_message)
{
  // Field name: name
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_serialize_key_gazebo_msgs__msg__WheelSlip(
  const gazebo_msgs__msg__WheelSlip * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: name
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t get_serialized_size_key_gazebo_msgs__msg__WheelSlip(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WheelSlip__ros_msg_type * ros_message = static_cast<const _WheelSlip__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t max_serialized_size_key_gazebo_msgs__msg__WheelSlip(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const gazebo_msgs__msg__WheelSlip * ros_message = static_cast<const gazebo_msgs__msg__WheelSlip *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_gazebo_msgs__msg__WheelSlip(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  gazebo_msgs__msg__WheelSlip * ros_message = static_cast<gazebo_msgs__msg__WheelSlip *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_gazebo_msgs__msg__WheelSlip(cdr, ros_message);
}
