...
#include "gazebo_msgs/msg/detail/world_state__rosidl_typesupport_fastrtps_c.h"
...
using _WorldState__ros_msg_type = gazebo_msgs__msg__WorldState;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_serialize_gazebo_msgs__msg__WorldState(
  const gazebo_msgs__msg__WorldState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_deserialize_gazebo_msgs__msg__WorldState(
  eprosima::fastcdr::Cdr & cdr,
  gazebo_msgs__msg__WorldState * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t get_serialized_size_gazebo_msgs__msg__WorldState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t max_serialized_size_gazebo_msgs__msg__WorldState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gazebo_msgs__msg__WorldState;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_serialize_key_gazebo_msgs__msg__WorldState(
  const gazebo_msgs__msg__WorldState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t get_serialized_size_key_gazebo_msgs__msg__WorldState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WorldState__ros_msg_type * ros_message = static_cast<const _WorldState__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t max_serialized_size_key_gazebo_msgs__msg__WorldState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const gazebo_msgs__msg__WorldState * ros_message = static_cast<const gazebo_msgs__msg__WorldState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_gazebo_msgs__msg__WorldState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  gazebo_msgs__msg__WorldState * ros_message = static_cast<gazebo_msgs__msg__WorldState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_gazebo_msgs__msg__WorldState(cdr, ros_message);
}

static uint32_t _WorldState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gazebo_msgs__msg__WorldState(
...
static size_t _WorldState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gazebo_msgs__msg__WorldState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, msg, WorldState)() {
