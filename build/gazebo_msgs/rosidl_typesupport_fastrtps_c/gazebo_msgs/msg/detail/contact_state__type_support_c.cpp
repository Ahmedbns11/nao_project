  ...
  gazebo_msgs__msg__ContactState * ros_message)
{
  ...
  // Field name: total_wrench
  {
    cdr_deserialize_geometry_msgs__msg__Wrench(cdr, &ros_message->total_wrench);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const gazebo_msgs__msg__ContactState * ros_message = static_cast<const gazebo_msgs__msg__ContactState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_gazebo_msgs__msg__ContactState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  gazebo_msgs__msg__ContactState * ros_message = static_cast<gazebo_msgs__msg__ContactState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_gazebo_msgs__msg__ContactState(cdr, ros_message);
}
