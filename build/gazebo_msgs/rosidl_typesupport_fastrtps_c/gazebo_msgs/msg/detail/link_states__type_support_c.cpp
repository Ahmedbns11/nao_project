...
#include "gazebo_msgs/msg/detail/link_states__rosidl_typesupport_fastrtps_c.h"
...
using _LinkStates__ros_msg_type = gazebo_msgs__msg__LinkStates;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_serialize_gazebo_msgs__msg__LinkStates(
  const gazebo_msgs__msg__LinkStates * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: name
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_deserialize_gazebo_msgs__msg__LinkStates(
  eprosima::fastcdr::Cdr & cdr,
  gazebo_msgs__msg__LinkStates * ros_message)
{
  // Field name: name
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t get_serialized_size_gazebo_msgs__msg__LinkStates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LinkStates__ros_msg_type * ros_message = static_cast<const _LinkStates__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t max_serialized_size_gazebo_msgs__msg__LinkStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gazebo_msgs__msg__LinkStates;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_serialize_key_gazebo_msgs__msg__LinkStates(
  const gazebo_msgs__msg__LinkStates * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: name
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t get_serialized_size_key_gazebo_msgs__msg__LinkStates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LinkStates__ros_msg_type * ros_message = static_cast<const _LinkStates__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t max_serialized_size_key_gazebo_msgs__msg__LinkStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const gazebo_msgs__msg__LinkStates * ros_message = static_cast<const gazebo_msgs__msg__LinkStates *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_gazebo_msgs__msg__LinkStates(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  gazebo_msgs__msg__LinkStates * ros_message = static_cast<gazebo_msgs__msg__LinkStates *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_gazebo_msgs__msg__LinkStates(cdr, ros_message);
}

static uint32_t _LinkStates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gazebo_msgs__msg__LinkStates(
      untyped_ros_message, 0));
}

static size_t _LinkStates__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_gazebo_msgs__msg__LinkStates(
...
static message_type_support_callbacks_t __callbacks_LinkStates = {
  "gazebo_msgs::msg",
  "LinkStates",
...
static rosidl_message_type_support_t _LinkStates__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LinkStates,
  get_message_typesupport_handle_function,
  &gazebo_msgs__msg__LinkStates__get_type_hash,
  &gazebo_msgs__msg__LinkStates__get_type_description,
  &gazebo_msgs__msg__LinkStates__get_type_description_sources,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, msg, LinkStates)() {
  return &_LinkStates__type_support;
}
