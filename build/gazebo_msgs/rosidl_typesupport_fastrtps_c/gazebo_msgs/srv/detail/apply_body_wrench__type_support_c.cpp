...
#include "gazebo_msgs/srv/detail/apply_body_wrench__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // body_name, reference_frame
#include "rosidl_runtime_c/string_functions.h"  // body_name, reference_frame
...
bool cdr_serialize_gazebo_msgs__srv__ApplyBodyWrench_Request(
  const gazebo_msgs__srv__ApplyBodyWrench_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_deserialize_gazebo_msgs__srv__ApplyBodyWrench_Request(
  eprosima::fastcdr::Cdr & cdr,
  gazebo_msgs__srv__ApplyBodyWrench_Request * ros_message)
{
  // Field name: body_name
  {
    std::string tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gazebo_msgs__srv__ApplyBodyWrench_Request;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_serialize_key_gazebo_msgs__srv__ApplyBodyWrench_Request(
  const gazebo_msgs__srv__ApplyBodyWrench_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: body_name
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t get_serialized_size_key_gazebo_msgs__srv__ApplyBodyWrench_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ApplyBodyWrench_Request__ros_msg_type * ros_message = static_cast<const _ApplyBodyWrench_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t max_serialized_size_key_gazebo_msgs__srv__ApplyBodyWrench_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const gazebo_msgs__srv__ApplyBodyWrench_Request * ros_message = static_cast<const gazebo_msgs__srv__ApplyBodyWrench_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_gazebo_msgs__srv__ApplyBodyWrench_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  gazebo_msgs__srv__ApplyBodyWrench_Request * ros_message = static_cast<gazebo_msgs__srv__ApplyBodyWrench_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_gazebo_msgs__srv__ApplyBodyWrench_Request(cdr, ros_message);
}
...
static size_t _ApplyBodyWrench_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gazebo_msgs__srv__ApplyBodyWrench_Request(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_serialize_gazebo_msgs__srv__ApplyBodyWrench_Response(
  const gazebo_msgs__srv__ApplyBodyWrench_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_deserialize_gazebo_msgs__srv__ApplyBodyWrench_Response(
  eprosima::fastcdr::Cdr & cdr,
  gazebo_msgs__srv__ApplyBodyWrench_Response * ros_message)
{
  // Field name: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = gazebo_msgs__srv__ApplyBodyWrench_Response;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_serialize_key_gazebo_msgs__srv__ApplyBodyWrench_Response(
  const gazebo_msgs__srv__ApplyBodyWrench_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t get_serialized_size_key_gazebo_msgs__srv__ApplyBodyWrench_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ApplyBodyWrench_Response__ros_msg_type * ros_message = static_cast<const _ApplyBodyWrench_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t max_serialized_size_key_gazebo_msgs__srv__ApplyBodyWrench_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const gazebo_msgs__srv__ApplyBodyWrench_Response * ros_message = static_cast<const gazebo_msgs__srv__ApplyBodyWrench_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_gazebo_msgs__srv__ApplyBodyWrench_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  gazebo_msgs__srv__ApplyBodyWrench_Response * ros_message = static_cast<gazebo_msgs__srv__ApplyBodyWrench_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_gazebo_msgs__srv__ApplyBodyWrench_Response(cdr, ros_message);
}
...
static size_t _ApplyBodyWrench_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gazebo_msgs__srv__ApplyBodyWrench_Response(
    full_bounded, is_plain, 0);
...
using _ApplyBodyWrench_Event__ros_msg_type = gazebo_msgs__srv__ApplyBodyWrench_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_serialize_gazebo_msgs__srv__ApplyBodyWrench_Event(
  const gazebo_msgs__srv__ApplyBodyWrench_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_gazebo_msgs__srv__ApplyBodyWrench_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_gazebo_msgs__srv__ApplyBodyWrench_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_deserialize_gazebo_msgs__srv__ApplyBodyWrench_Event(
  eprosima::fastcdr::Cdr & cdr,
  gazebo_msgs__srv__ApplyBodyWrench_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      gazebo_msgs__srv__ApplyBodyWrench_Request__Sequence__fini(&ros_message->request);
    }
    if (!gazebo_msgs__srv__ApplyBodyWrench_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_gazebo_msgs__srv__ApplyBodyWrench_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      gazebo_msgs__srv__ApplyBodyWrench_Response__Sequence__fini(&ros_message->response);
    }
    if (!gazebo_msgs__srv__ApplyBodyWrench_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_gazebo_msgs__srv__ApplyBodyWrench_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t get_serialized_size_gazebo_msgs__srv__ApplyBodyWrench_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ApplyBodyWrench_Event__ros_msg_type * ros_message = static_cast<const _ApplyBodyWrench_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_gazebo_msgs__srv__ApplyBodyWrench_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_gazebo_msgs__srv__ApplyBodyWrench_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t max_serialized_size_gazebo_msgs__srv__ApplyBodyWrench_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_gazebo_msgs__srv__ApplyBodyWrench_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_gazebo_msgs__srv__ApplyBodyWrench_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = gazebo_msgs__srv__ApplyBodyWrench_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
bool cdr_serialize_key_gazebo_msgs__srv__ApplyBodyWrench_Event(
  const gazebo_msgs__srv__ApplyBodyWrench_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_gazebo_msgs__srv__ApplyBodyWrench_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_gazebo_msgs__srv__ApplyBodyWrench_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t get_serialized_size_key_gazebo_msgs__srv__ApplyBodyWrench_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ApplyBodyWrench_Event__ros_msg_type * ros_message = static_cast<const _ApplyBodyWrench_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_gazebo_msgs__srv__ApplyBodyWrench_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_gazebo_msgs__srv__ApplyBodyWrench_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gazebo_msgs
size_t max_serialized_size_key_gazebo_msgs__srv__ApplyBodyWrench_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_gazebo_msgs__srv__ApplyBodyWrench_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_gazebo_msgs__srv__ApplyBodyWrench_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _ApplyBodyWrench_Event__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  if (!untyped_ros_message) {
  ...
  const gazebo_msgs__srv__ApplyBodyWrench_Event * ros_message = static_cast<const gazebo_msgs__srv__ApplyBodyWrench_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_gazebo_msgs__srv__ApplyBodyWrench_Event(ros_message, cdr);
}

static bool _ApplyBodyWrench_Event__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  if (!untyped_ros_message) {
  ...
  gazebo_msgs__srv__ApplyBodyWrench_Event * ros_message = static_cast<gazebo_msgs__srv__ApplyBodyWrench_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_gazebo_msgs__srv__ApplyBodyWrench_Event(cdr, ros_message);
}

static uint32_t _ApplyBodyWrench_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gazebo_msgs__srv__ApplyBodyWrench_Event(
      untyped_ros_message, 0));
}

static size_t _ApplyBodyWrench_Event__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_gazebo_msgs__srv__ApplyBodyWrench_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_ApplyBodyWrench_Event = {
  "gazebo_msgs::srv",
  "ApplyBodyWrench_Event",
  _ApplyBodyWrench_Event__cdr_serialize,
  _ApplyBodyWrench_Event__cdr_deserialize,
  _ApplyBodyWrench_Event__get_serialized_size,
  _ApplyBodyWrench_Event__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _ApplyBodyWrench_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ApplyBodyWrench_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, srv, ApplyBodyWrench_Event)() {
  return &_ApplyBodyWrench_Event__type_support;
}
...
static rosidl_service_type_support_t ApplyBodyWrench__handle = {
  ...
  &_ApplyBodyWrench_Request__type_support,
  &_ApplyBodyWrench_Response__type_support,
  &_ApplyBodyWrench_Event__type_support,
