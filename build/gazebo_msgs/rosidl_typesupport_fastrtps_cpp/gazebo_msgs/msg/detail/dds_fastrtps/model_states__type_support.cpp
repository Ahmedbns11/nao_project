...
#include "gazebo_msgs/msg/detail/model_states__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gazebo_msgs::msg::ModelStates & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gazebo_msgs::msg::ModelStates & ros_message)
{
  // Member: name
  {
    cdr >> ros_message.name;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_gazebo_msgs
max_serialized_size_ModelStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gazebo_msgs::msg::ModelStates;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_gazebo_msgs
max_serialized_size_key_ModelStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const gazebo_msgs::msg::ModelStates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gazebo_msgs::msg::ModelStates *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ModelStates__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gazebo_msgs::msg::ModelStates *>(
...
static size_t _ModelStates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ModelStates(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ModelStates__callbacks = {
  "gazebo_msgs::msg",
  "ModelStates",
...
static rosidl_message_type_support_t _ModelStates__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ModelStates__callbacks,
...
{
  return &gazebo_msgs::msg::typesupport_fastrtps_cpp::_ModelStates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gazebo_msgs, msg, ModelStates)() {
  return &gazebo_msgs::msg::typesupport_fastrtps_cpp::_ModelStates__handle;
}
