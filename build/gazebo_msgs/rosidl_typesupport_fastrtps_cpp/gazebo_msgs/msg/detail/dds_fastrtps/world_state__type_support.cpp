...
#include "gazebo_msgs/msg/detail/world_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gazebo_msgs::msg::WorldState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gazebo_msgs::msg::WorldState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gazebo_msgs::msg::WorldState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gazebo_msgs::msg::WorldState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gazebo_msgs::msg::WorldState *>(
    untyped_ros_message);
...
{
  return &gazebo_msgs::msg::typesupport_fastrtps_cpp::_WorldState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gazebo_msgs, msg, WorldState)() {
  return &gazebo_msgs::msg::typesupport_fastrtps_cpp::_WorldState__handle;
}
