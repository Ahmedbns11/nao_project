  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x94, 0x8f, 0xbd, 0x9d, 0x34, 0x5a, 0x29, 0x85,
      0x88, 0xea, 0x99, 0x74, 0x23, 0x62, 0xd6, 0x51,
      0xa7, 0x3b, 0xdc, 0x46, 0x63, 0x7d, 0xea, 0x11,
      0x58, 0xbc, 0xad, 0xce, 0x85, 0x9c, 0xb6, 0xf5,
    }};
  return &hash;
}
...
static char gazebo_msgs__msg__ModelStates__TYPE_NAME[] = "gazebo_msgs/msg/ModelStates";
...
static char gazebo_msgs__msg__ModelStates__FIELD_NAME__name[] = "name";
static char gazebo_msgs__msg__ModelStates__FIELD_NAME__pose[] = "pose";
static char gazebo_msgs__msg__ModelStates__FIELD_NAME__twist[] = "twist";

static rosidl_runtime_c__type_description__Field gazebo_msgs__msg__ModelStates__FIELDS[] = {
  {
    {gazebo_msgs__msg__ModelStates__FIELD_NAME__name, 4, 4},
    {
  ...
  {
    {gazebo_msgs__msg__ModelStates__FIELD_NAME__pose, 4, 4},
    {
  ...
  {
    {gazebo_msgs__msg__ModelStates__FIELD_NAME__twist, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription gazebo_msgs__msg__ModelStates__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {gazebo_msgs__msg__ModelStates__TYPE_NAME, 27, 27},
      {gazebo_msgs__msg__ModelStates__FIELDS, 3, 3},
    },
    {gazebo_msgs__msg__ModelStates__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
...
gazebo_msgs__msg__ModelStates__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *gazebo_msgs__msg__ModelStates__get_individual_type_description_source(NULL),
