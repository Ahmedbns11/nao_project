...
gazebo_msgs__msg__LinkState__get_type_hash(
...
static char gazebo_msgs__msg__LinkState__FIELD_NAME__link_name[] = "link_name";
static char gazebo_msgs__msg__LinkState__FIELD_NAME__pose[] = "pose";
static char gazebo_msgs__msg__LinkState__FIELD_NAME__twist[] = "twist";
static char gazebo_msgs__msg__LinkState__FIELD_NAME__reference_frame[] = "reference_frame";

static rosidl_runtime_c__type_description__Field gazebo_msgs__msg__LinkState__FIELDS[] = {
  {
    {gazebo_msgs__msg__LinkState__FIELD_NAME__link_name, 9, 9},
    {
  ...
  {
    {gazebo_msgs__msg__LinkState__FIELD_NAME__pose, 4, 4},
    {
  ...
  {
    {gazebo_msgs__msg__LinkState__FIELD_NAME__twist, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {gazebo_msgs__msg__LinkState__FIELD_NAME__reference_frame, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription gazebo_msgs__msg__LinkState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
gazebo_msgs__msg__LinkState__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {gazebo_msgs__msg__LinkState__FIELDS, 4, 4},
    },
    {gazebo_msgs__msg__LinkState__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
...
gazebo_msgs__msg__LinkState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
gazebo_msgs__msg__LinkState__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *gazebo_msgs__msg__LinkState__get_individual_type_description_source(NULL),
