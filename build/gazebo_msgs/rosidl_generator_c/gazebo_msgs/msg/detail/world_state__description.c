  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x80, 0x34, 0x8c, 0x0a, 0x5e, 0x54, 0x09, 0x35,
      0x82, 0xe7, 0x4f, 0x96, 0xfa, 0xec, 0x24, 0x10,
      0x3e, 0x26, 0xfc, 0xab, 0xbb, 0xa6, 0xc3, 0x62,
      0x98, 0xdc, 0x37, 0xed, 0xe5, 0x14, 0xdb, 0x9f,
    }};
  return &hash;
}
...
static char gazebo_msgs__msg__WorldState__TYPE_NAME[] = "gazebo_msgs/msg/WorldState";
...
static char gazebo_msgs__msg__WorldState__FIELD_NAME__header[] = "header";
static char gazebo_msgs__msg__WorldState__FIELD_NAME__name[] = "name";
static char gazebo_msgs__msg__WorldState__FIELD_NAME__pose[] = "pose";
static char gazebo_msgs__msg__WorldState__FIELD_NAME__twist[] = "twist";
static char gazebo_msgs__msg__WorldState__FIELD_NAME__wrench[] = "wrench";

static rosidl_runtime_c__type_description__Field gazebo_msgs__msg__WorldState__FIELDS[] = {
  {
    {gazebo_msgs__msg__WorldState__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {gazebo_msgs__msg__WorldState__FIELD_NAME__name, 4, 4},
    {
  ...
  {
    {gazebo_msgs__msg__WorldState__FIELD_NAME__pose, 4, 4},
    {
  ...
  {
    {gazebo_msgs__msg__WorldState__FIELD_NAME__twist, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {gazebo_msgs__msg__WorldState__FIELD_NAME__wrench, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription gazebo_msgs__msg__WorldState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {gazebo_msgs__msg__WorldState__TYPE_NAME, 26, 26},
      {gazebo_msgs__msg__WorldState__FIELDS, 5, 5},
    },
    {gazebo_msgs__msg__WorldState__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
...
gazebo_msgs__msg__WorldState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {gazebo_msgs__msg__WorldState__TYPE_NAME, 26, 26},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 1620, 1620},
  };
  return &source;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *gazebo_msgs__msg__WorldState__get_individual_type_description_source(NULL),
